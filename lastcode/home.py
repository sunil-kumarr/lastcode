"""
home.py — Home screen for lastcode: topic/difficulty filters, search, and problem list.
"""
...
from lastcode.problems.registry import TOPICS, DIFFICULTIES, PROBLEMS
from lastcode.theme import THEMES
