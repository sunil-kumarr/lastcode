"""Binary Tree Zigzag Level Order Traversal — full implementation."""
...
DEFAULT_INPUT = [8, 4, 12, 2, 6, 10, 14, 1, 3, 5, 7, 9, 11, 13, 15]
...
def _zigzag_level_order_instrumented(root: "_TreeNode") -> list[list[int]]:
    if not root:
        return []
...
def run(input_data: list) -> list[dict]:
    ...
    frames = recorder.record(
        "_zigzag_level_order_instrumented",
        _zigzag_level_order_instrumented,
        root,
