"""Balanced Binary Tree — full implementation."""
...
DEFAULT_INPUT = [3, 9, 20, None, None, 15, 7]
...
def _balanced_bt_instrumented(root: "_TreeNode") -> bool:
